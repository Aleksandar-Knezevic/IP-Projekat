        ...
        <div class="contact-footer">
            ...
            <div>
                <form action="PosaljiPorukuServlet" method="POST" class="form-contact">
                    ...
                    <input type="text" name="naslov" id="naslov" placeholder="naslov" class="contact-input">
                    <textarea name="poruka" id="poruka" cols="30" rows="10" placeholder="Tekst poruke" class="contact-input"></textarea>
